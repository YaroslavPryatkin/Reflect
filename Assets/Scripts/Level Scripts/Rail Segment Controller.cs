...
public class RailSegmentController : MonoBehaviour
{
    ...
    public void SetForward(RailSegmentController forward)
    {
        _forward = forward.transform;
        _hasForward = true;
    }

    public void SetBackward(RailSegmentController backward)
    {
