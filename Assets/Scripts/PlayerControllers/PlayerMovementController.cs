...
// ── Movement ──────────────────────────────────────────────
    ...
    [Header("Speed Loss")] [SerializeField]
    ...
    private float startingWallRunSpeedThreshold = 0.5f;
    ...
    [Header("Delays after jump")] [SerializeField]
    private float canNotWallRunAfterWallRunDelay = 0.5f;
    ...
    [Header("Sliding")] [SerializeField] private float slideSpeedHardCap = 20f;
    ...
    private void Update()
    {
        ...
        _gettingHitController.CanGetStunned = wallRunningState == 0 && SlidingPhase == 0;
